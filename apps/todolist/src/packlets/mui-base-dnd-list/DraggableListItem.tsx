...
export type DraggableListItem = FunctionComponent<IDraggableListItemProps>;

export const DraggableListItem: DraggableListItem = ({ children, className, draggableProps, ...other }) => (
