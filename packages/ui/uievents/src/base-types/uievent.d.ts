...
/**
 * The {@link UIEvent} interface provides specific contextual information associated with User Interface events.
 *
 * @see https://www.w3.org/TR/uievents/#uievent
 */
...
/**
 * The {@link UIEventInit} interface defines a User Interface event initializer.
 *
...
export interface UIEventInit extends EventInit {
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dictdef-uieventinit
   */
  readonly view: Window | null;
  /**
 ...
 * for retrieving additional modifier states. The following {@link EventModifierInit} dictionary enables authors to initialize keyboard modifier
...
export interface EventModifierInit extends UIEventInit {
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-ctrlkey
   */
  ctrlKey: boolean;
  /**
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-shiftkey
   */
  shiftKey: boolean;
  /**
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-altkey
   */
  altKey: boolean;
  /**
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-metakey
   */
  metaKey: boolean;
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifieraltgraph
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifiercapslock
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifierfn
   */
  modifierFn: boolean;
  /**
   * Initializes the event object’s key modifier state such that calls to the getModifierState()
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifierfnlock
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifierhyper
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifiernumlock
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifierscrolllock
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifiersuper
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifiersymbol
   */
   ...
   *
   * @see https://www.w3.org/TR/uievents/#dom-eventmodifierinit-modifiersymbollock
   */
